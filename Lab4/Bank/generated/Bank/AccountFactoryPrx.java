...
{
    default AccountCreated createAccount(String name, String surname, String pesel, double balance)
    {
        return createAccount(name, surname, pesel, balance, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default AccountCreated createAccount(String name, String surname, String pesel, double balance, java.util.Map<String, String> context)
    {
        return _iceI_createAccountAsync(name, surname, pesel, balance, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<AccountCreated> createAccountAsync(String name, String surname, String pesel, double balance)
    {
        return _iceI_createAccountAsync(name, surname, pesel, balance, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<AccountCreated> createAccountAsync(String name, String surname, String pesel, double balance, java.util.Map<String, String> context)
    {
        return _iceI_createAccountAsync(name, surname, pesel, balance, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<AccountCreated> _iceI_createAccountAsync(String iceP_name, String iceP_surname, String iceP_pesel, double iceP_balance, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<AccountCreated> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "createAccount", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ...
                     AccountCreated ret;
                     ret = AccountCreated.ice_read(istr);
                     return ret;
                 });
        return f;
    }

    default AccountPrx obtainAccess(Credentials userCredentials)
        throws InvalidCredentialsException
    {
        return obtainAccess(userCredentials, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default AccountPrx obtainAccess(Credentials userCredentials, java.util.Map<String, String> context)
        throws InvalidCredentialsException
    {
        try
        {
            return _iceI_obtainAccessAsync(userCredentials, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<AccountPrx> obtainAccessAsync(Credentials userCredentials)
    {
        return _iceI_obtainAccessAsync(userCredentials, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<AccountPrx> obtainAccessAsync(Credentials userCredentials, java.util.Map<String, String> context)
    {
        return _iceI_obtainAccessAsync(userCredentials, context, false);
    }

    /**
     * @hidden
     * @param iceP_userCredentials -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<AccountPrx> _iceI_obtainAccessAsync(Credentials iceP_userCredentials, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<AccountPrx> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "obtainAccess", null, sync, _iceE_obtainAccess);
        f.invoke(true, context, null, ostr -> {
                     Credentials.ice_write(ostr, iceP_userCredentials);
                 }, istr -> {
                     AccountPrx ret;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_obtainAccess =
    {
