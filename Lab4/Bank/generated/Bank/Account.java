...
public interface Account extends com.zeroc.Ice.Object
{
    ...
    CreditEstimate applyForCredit(Currency creditCurrency, double balance, String period, com.zeroc.Ice.Current current)
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        Currency iceP_creditCurrency;
        double iceP_balance;
        String iceP_period;
        iceP_creditCurrency = Currency.ice_read(istr);
        iceP_balance = istr.readDouble();
        iceP_period = istr.readString();
        inS.endReadParams();
        CreditEstimate ret = obj.applyForCredit(iceP_creditCurrency, iceP_balance, iceP_period, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        CreditEstimate.ice_write(ostr, ret);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);
    }
